...
public class VueProjectGenStreamManager {
    ...
    public class GenSession {
        ...
        public GenSession(Long appId, String message) {
            ...
            this.chatSink = Sinks.many().multicast().onBackpressureBuffer(256, false);
            this.detailSink = Sinks.many().multicast().onBackpressureBuffer(256, false);
        }
            ...
            try {
                ...
                tokenStream.onPartialResponse((String partialResponse) -> {
                        ...
                        .onCompleteResponse((ChatResponse response) -> {
                            ...
                            // 执行 Vue 项目构建，并实时推送构建进度
                            String projectPath = AppConstant.CODE_OUTPUT_ROOT_DIR + File.separator + "vue_project_" + appId;
                            boolean buildSuccess = vueProjectBuilder.buildProject(projectPath, line ->
                                    detailSink.tryEmitNext(buildEvent(CodeGenStreamEventType.BUILD_PROGRESS, null, null, null, line, null))
                            );
